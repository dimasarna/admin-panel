            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form
                    ...
                    x-data="{
                        ...
                        name : '{{ old('name', $question->name) }}',
                        choice_1 : '{{ old('choice_1', $question->choice_1) }}',
                        choice_2 : '{{ old('choice_2', $question->choice_2) }}',
                        choice_3 : '{{ old('choice_3', $question->choice_3) }}',
                        choice_4 : '{{ old('choice_4', $question->choice_4) }}',
